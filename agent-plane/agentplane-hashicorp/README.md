...
```console
docker build -t ghcr.io/eclipse-tractusx/knowledge-agents-edc/agentplane-hashicorp:1.9.5-SNAPSHOT -f src/main/docker/Dockerfile .
```
...
docker run -p 8082:8082 \
  ...
  ghcr.io/eclipse-tractusx/knowledge-agents-edc/agentplane-hashicorp:1.9.5-SNAPSHOT
````
