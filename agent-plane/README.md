...
```console
docker build -t tractusx/agentplane-azure-vault:1.10.5-SNAPSHOT -f agentplane-azure-vault/src/main/docker/Dockerfile .
```

```console
docker build -t tractusx/agentplane-hashicorp:1.10.5-SNAPSHOT -f agentplane-hashicorp/src/main/docker/Dockerfile .
```
