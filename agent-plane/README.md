...
```console
docker build -t tractusx/agentplane-azure-vault:1.10.15 -f agentplane-azure-vault/src/main/docker/Dockerfile .
```

```console
docker build -t tractusx/agentplane-hashicorp:1.10.15 -f agentplane-hashicorp/src/main/docker/Dockerfile .
```
